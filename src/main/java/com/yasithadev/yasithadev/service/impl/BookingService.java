...
import com.yasithadev.yasithadev.repo.BookingRepository;
import com.yasithadev.yasithadev.repo.RoomRepository;
import com.yasithadev.yasithadev.repo.UserRepository;
import com.yasithadev.yasithadev.service.interfac.IBookingService;
...
public class BookingService implements IBookingService {
    ...
    public Response findBookingByConfirmationCode(String confirmationCode) {
        ...
        try {
            //TODO : Booking booking = bookingRepository.findByBookingConfirmationCode(confirmationCode).orElseThrow(() -> new OurException("Booking Not Found"));
            List<Booking> bookings = bookingRepository.findByBookingConfirmationCode(confirmationCode);
            if (bookings.isEmpty()) {
